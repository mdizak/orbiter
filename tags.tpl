...
[[form.editor]]
<textarea name="~name~" class="form-control" id="~name~" style="width: 100%" ~placeholder~>~value~</textarea>
...
[[nav.header]]
<li><span><h3>~name~</h3></span></li>


[[nav.parent]]
<li>
    <a href="javaScript:void();">
        ~icon~ <span>~name~</span><i class="feather icon-chevron-right pull-right"></i>
    </a>
...
* <a:modal>
*
* The modal box that eappears in the middle of the screen as 
* a pop-up dialog box.
********************

[[modal]]
<div id="apex_modal" class="modal" role="dialog">
    <div class="modal-content">

        <div class="modal-header">
            <button type="button" class="close" onclick="close_modal();">&times;</button>
            <h4 class="modal-title" id="apex_modal-title"></h4>
        </div>
        <div Class="modal-body" id="apex_modal-body"></div>
...
<li class="media dropdown-item">
    ...
    <div class="media-body">
        <a href="~url~"><h5 class="action-title">~message~</h5></a>
        <p><span class="timing">~time~</span></p>                            
    </div>
</li>
...
<div class="panel panel-flat">
    <a:function alias="display_tabcontrol" tabcontrol="core:dashboard">
</div>
...
<div class="col-lg-4">
    <div class="~panel_class~">
        <div class="panel-body">
            ...
            <h3 class="no-margin">~contents~</h3>
                ~title~
            </div>
